...
type MultiplexingConfig struct {
	...
	// Stop accepting new mux sessions after this many seconds. 0 keeps the
	// worker until it is idle. Workers are force-closed at 2x this value.
...
func (x *MultiplexingConfig) GetMaxLifetime() int32 {
	if x != nil {
...
const file_app_proxyman_config_proto_rawDesc = "" +
	...
	"\x0ftarget_strategy\x18\x06 \x01(\x0e2'.xray.transport.internet.DomainStrategyR\x0etargetStrategy\"\xc7\x01\n" +
	...
	"\fmax_lifetime\x18\x05 \x01(\x05R\vmaxLifetimeBU\n" +
